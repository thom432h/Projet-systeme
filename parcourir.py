...
def main():
    ...
    print(f"Nombre d'échantillons : {len(groupes)}")
    # Affiche le nombre total d'échantillons.
    ...
    for identifiant, fichiers in groupes.items():
        ...
        print(f"Échantillon {identifiant} : Nombre de réplicats {len(fichiers)}")
        # Affiche l'identifiant et le nombre de réplicats.
